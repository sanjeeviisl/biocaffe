...
LEAF_CLASSES = (  # always index 0
                'potato_healthy','potato_early_blight','infected_potato_early_blight',
...
VOC_ROOT = osp.join(HOME, "LeafDetectData/")
...
class VOCAnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(LEAF_CLASSES, range(len(LEAF_CLASSES))))
